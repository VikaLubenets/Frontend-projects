...
1. Main (60 / 60):
1.1 Проверка верстки (7 / 7):
(+4б.) верстка страницы валидная: получена надпись "Document checking completed. No errors or warnings to show."
(+1б.) логотип в хедере состоит из текстовых элементов
(+1б.) страница содержит ровно один элемент
(+1б.) добавлен favicon
1.2 Вёрстка соответствует макету (35 / 35)
    блок <header> +5
    блок Not only +5
    блок About +5
    блок Our Friends +5
...
1.4 Интерактивность элементов (12 / 12)
...
2. Pets
2.1 Проверка верстки (7 / 7)
    верстка страницы валидная +4
    логотип в хедере состоит из текстовых элементов +1
    страница содержит ровно один элемент <h1> +1
    добавлен favicon +1
2.2 Вёрстка соответствует макету (15 / 15)
    блок <header> +5
    блок Our Friends +5
    блок <footer> +5
2.3 Требования к css (4 / 4)
    при уменьшении масштаба страницы браузера или увеличении ширины страницы (>1280px) вёрстка размещается по центру, а не сдвигается в сторону и не растягивается по всей ширине +2
    фоновый цвет тянется на всю ширину страницы +2
2.4 Интерактивность элементов (14 / 14)
